...
import { optSchedule2 } from "./optSchedule2";
...
export async function GET(request: Request) {
      ...
      subreqs: [
        {
          ...
          coursesToTake: [],
          coursesTaken: ["CS 1200", "CS 1210"],
          numRequired: 0,
        },
        {
          title: "Computer Science Fundamental Requirements",
          coursesToTake: [],
          coursesTaken: ["CS 1800", "CS 2500", "CS 2510"],
          numRequired: 0,
        },
        {
          ...
          coursesTaken: ["CS 3000", "CS 3500", "CS 3650", "CS 3800", "CS 2810"],
          numRequired: 1,
        },
        {
          title: "Security Required Course",
          coursesToTake: [],
          coursesTaken: ["CY 2550"],
          numRequired: 0,
        },
        {
          title: "Presentation Requirement",
          coursesToTake: [],
          coursesTaken: ["THTR 1125"],
          numRequired: 0,
        },
        {
  ...
  const allSubreqs = reqs
    .filter((r) => r.type == "major_requirement")
    .flatMap((r) => r.subreqs);

  const schedule = await optSchedule2(semesters, allSubreqs);
